...
import { KeepKeyHDWallet, KeepKeyHDWalletInfo, isKeepKey, info } from "@mcchadwick/hdwallet-keepkey";
import { NodeWebUSBKeepKeyAdapter } from "@mcchadwick/hdwallet-keepkey-nodewebusb";
