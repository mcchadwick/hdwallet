...
```bash
yarn add @mcchadwick/hdwallet-core
yarn add @mcchadwick/hdwallet-keepkey-webusb
yarn add @mcchadwick/hdwallet-trezor-connect
yarn add @mcchadwick/hdwallet-ledger-webusb
```
...
```javascript
import { HDWallet } from "@mcchadwick/hdwallet-core";
import { isKeepKey, KeepKeyHDWallet } from "@mcchadwick/hdwallet-keepkey";
import { isLedger, LedgerHDWallet } from "@mcchadwick/hdwallet-ledger";
import { isTrezor, TrezorHDWallet } from "@mcchadwick/hdwallet-trezor";
